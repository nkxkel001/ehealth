...
public class Alert {
	...
	public File getDataFile(){
		...
		try {
			...
			String dataArray = this.data.getStringValues();
			outfile.write("DateMonitored: "+data.getDateMonitored());
	...
	public String AlertDoctor(){
		...
		String body = "Abnormal health status detected for "+ user.toString()+ " based on data monitored at (date and time): "+data.getDateMonitored()+"/n See data file attached.";		
